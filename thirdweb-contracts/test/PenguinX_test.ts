...
describe("PenguinX", function () {
  ...
  async function buyListing(penguin_x_marketplace, penguin_master, penguin_verifier, seller_account, buyer_account, random_account, penguin_x_nft) {
    ...
    // const deliveryData = {
    //   "zone": 0,
    //   "name": utf8Encode.encode("sans"),
    //   "full_address": utf8Encode.encode("abc street"),
    //   "zip": utf8Encode.encode("4201"),
    //   "city": utf8Encode.encode("Cali"),
    //   "gov_id": utf8Encode.encode("42095"),
    //   "email": utf8Encode.encode("san@ti.ago"),
    //   "phone": utf8Encode.encode("777")
    // }
    const deliveryData = {
      "zone": 1,
      "name": utf8Encode.encode("sans"),
      "full_address": utf8Encode.encode("abc street"),
      "d_state": utf8Encode.encode("Cun"),
      "zip": utf8Encode.encode("4201"),
      "city": utf8Encode.encode("Saname"),
      "gov_id": utf8Encode.encode("42095"),
      "email": utf8Encode.encode("san@ti.ago"),
      "phone": utf8Encode.encode("777"),
      "tracking_code": [],
